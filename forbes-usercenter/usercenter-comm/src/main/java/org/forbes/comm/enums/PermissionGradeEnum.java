...
public enum PermissionGradeEnum {
     ...
     * @修改日期 (请填上修改该文件时的日期)
     */
    public static boolean existsPermissionGradeEnum(String code){
        return Arrays.asList(PermissionGradeEnum.values()).stream()
     ...
     * @修改日期 (请填上修改该文件时的日期)
     */
    public static List<Map<String,String>> recePermissionGrades(){
        return Arrays.asList(PermissionGradeEnum.values()).stream().map(tEnum -> {
     ...
     * @param name
     */
    PermissionGradeEnum(String code, String name){
        this.code = code;
        this.name = name;
    }
